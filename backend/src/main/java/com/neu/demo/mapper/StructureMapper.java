...
public interface StructureMapper {
    ...
    void insertModule(Structure structure);

    //删除节点
    @Delete("delete from t_structure where module_id = #{module_id}")
    int deleteModule(int module_id);
    ...
    Structure getModuleById(int module_id);
}
